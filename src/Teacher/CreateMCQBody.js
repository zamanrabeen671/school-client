...
export default function CreateMCQBody({ questionHeader }) {
  ...
  return (
    <div className='container'>
      <p className='text-success text-center fs-lg'>{message}</p>
      <form onSubmit={handleSubmit(onSubmit)} className='bg-light py-5 px-3 shadow-sm rounded'>
        ...
        <div className="d-flex justify-content-center">
          {
            message.length ? <button className="btn btn-primary mb-3" onClick={handleNavigate}>Go Home</button> : <button type="submit" className="btn btn-primary mb-3" >Next</button>
          }
